    ...
    <div class="row g-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    <i
                        class="bi bi-calendar-check fs-1 {{ $todayAttendance ? ($todayAttendance->status === 'Present' ? 'text-success' : 'text-danger') : 'text-muted' }}"></i>
                    <div class="fw-semibold mt-2">Today's Attendance</div>
                    @if ($todayAttendance)
                        <span
                            class="badge {{ $todayAttendance->status === 'Present' ? 'badge-present' : 'badge-absent' }} mt-1 px-3 py-1 rounded-pill">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    ...
                    @if ($lastExam)
                        <div class="fw-bold mt-1 text-primary">{{ $lastExam->marks_obtained }} /
                            {{ $lastExam->exam->full_marks }}</div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    ...
                    @if ($latestMaterial)
                        <div class="text-truncate fw-bold mt-1 text-info small">
                            {{ $latestMaterial->material->name ?? '-' }}</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('student.fees') }}" class="btn btn-outline-success btn-sm"><i
                                class="bi bi-cash-coin me-1"></i>Fee History</a>
                        <a href="{{ route('student.attendance') }}" class="btn btn-outline-primary btn-sm"><i
                                class="bi bi-calendar-check me-1"></i>Attendance</a>
                        <a href="{{ route('student.exams') }}" class="btn btn-outline-info btn-sm"><i
                                class="bi bi-journal-text me-1"></i>Exam Results</a>
                        <a href="{{ route('student.materials') }}" class="btn btn-outline-secondary btn-sm"><i
                                class="bi bi-bag me-1"></i>My Materials</a>
                    </div>
                </div>
            </div>
        </div>
