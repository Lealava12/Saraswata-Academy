...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.staff-salary.create') }}" class="btn btn-accent btn-sm" data-mpin-gate="true"><i class="bi bi-plus-lg me-1"></i>Pay Salary</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table data-table table-hover w-100">
                <thead class="table-light"><tr><th>#</th><th>Staff</th><th>Role</th><th>Month</th><th>Amount</th><th>Date</th><th>Action</th></tr></thead>
                <tbody>
