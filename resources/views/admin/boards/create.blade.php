...
@section('page-title', 'Add Board')

@section('content')
<div class="card" style="max-width:500px">
    <div class="card-header d-flex justify-content-between">
        <span><i class="bi bi-grid-fill me-2"></i>Add Board</span>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.boards.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. CBSE" required>
