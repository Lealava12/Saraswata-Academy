...
<title>Reset Password – Saraswata Academy</title>
...
<input type="password"
       ...
       required>
<span class="input-group-text eye-toggle" onclick="togglePwd('newPwd', this)">
<i class="bi bi-eye"></i>
</span>
</div>
</div>
...
<input type="password"
       ...
       required>
<span class="input-group-text eye-toggle" onclick="togglePwd('confirmPwd', this)">
<i class="bi bi-eye"></i>
</span>
</div>
</div>
