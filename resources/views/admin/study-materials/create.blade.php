...
<div class="card" style="max-width:600px">
    <div class="card-header d-flex justify-content-between">
        <span><i class="bi bi-bag-fill me-2"></i>Add Study Material</span>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.study-materials.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Class 10 Math Notes" required>
            </div>
            <div class="mb-3">
                <label class="form-label fw-medium">Description</label>
                <textarea name="description" class="form-control" rows="4" placeholder="Optional notes about this material…">{{ old('description') }}</textarea>
            </div>
            <div class="mb-3">
