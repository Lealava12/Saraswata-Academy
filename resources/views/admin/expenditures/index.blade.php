...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.expenditures.create') }}" class="btn btn-accent btn-sm"><i
                class="bi bi-plus-lg me-1"></i>Add Expenditure</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.expenditures.edit', $e->id) }}"
